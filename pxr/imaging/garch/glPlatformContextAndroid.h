...
class GarchAndroidContextState
{
public:
    /// Construct with the current state.
    GarchAndroidContextState();

    /// Construct with the given state.
    GarchAndroidContextState(EGLDisplay, EGLSurface, EGLContext);

    /// Compare for equality.
    bool operator==(const GarchAndroidContextState& rhs) const;
...
typedef GarchAndroidContextState GarchGLPlatformContextState;
